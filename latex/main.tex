...
%-------------------------------------------------------------------------------
%   Fast preview mode for thesis drafting
%-------------------------------------------------------------------------------

\newif\ifthesisfastpreview
\thesisfastpreviewfalse % Set to \thesisfastpreviewtrue for faster preview builds, especially with \includeonly below.

\newcommand{\thesispreviewgraphicbox}[2][0.92\linewidth]{%
    \fbox{%
        \parbox[c][0.24\textheight][c]{\dimexpr #1 - 2\fboxsep - 2\fboxrule\relax}{%
            \centering
            Preview placeholder for figure\\[0.4em]
            \texttt{\detokenize{#2}}%
        }%
    }%
}

\newcommand{\thesispreviewfallbackgraphicbox}[3][0.92\linewidth]{%
    \fbox{%
        \parbox[c][0.24\textheight][c]{\dimexpr #1 - 2\fboxsep - 2\fboxrule\relax}{%
            \centering
            Preview placeholder for figure\\[0.4em]
            Preferred: \texttt{\detokenize{#2}}\\[0.2em]
            Fallback: \texttt{\detokenize{#3}}%
        }%
    }%
}
