...
\begin{figure}[htbp]
    ...
    respectively. Left column: homogeneous case,
    \(\Delta_{\mathrm{inh}}=0\). Right column: inhomogeneous case,
    \(\Delta_{\mathrm{inh}}=\SI{200}{\per\centi\metre}\).}
...
monomer plots for \(N_{\mathrm{inhom}}=10\) and \(100\). (b) is visibly smoother while (a) shows stronger jagged fluctuations from finite-sampling. Also larger pulse amplitudes relative to the main-text are tested here but this has no effect, even though enabling populations of excited states above 1\% (see~\autoref{app:sec:one_pulse_subtraction}). However it can be seen that this has no effect since single-pulse polarisations are subtracted. Nevertheless due to consistency with the paper the pulse amplitudes were chosen as $0.2$ for the main text discussions.
...
\begin{figure}[htbp]
    \centering
    \safeplaceholdergraphic[1.22\linewidth]{figures/app_monomer_legacy_fig4_t0_freq}
    \caption{Inhomogeneous phenomenological monomer 2D frequency-domain spectra for
    the same runs as in~\autoref{fig:app_monomer_legacy_fig4_t0_time}. Shared
    settings are listed in~\autoref{subsec:results_monomer_model}.}
    \label{fig:app_monomer_legacy_fig4_t0_freq}
\end{figure}


\autoref{fig:app_monomer_legacy_redfield} shows a microscopic Redfield run in the
...
cases. Relative to the main-text monomer figures, this run uses
...
\begin{figure}[htbp]
    ...
    \caption{Inhomogeneous microscopic Redfield monomer 2D time-domain and
    frequency-domain signals at $t_{\mathrm{wait}}=\SI{0}{\femto\second}$.
    Shared settings are listed in~\autoref{subsec:results_monomer_model}. The
    plotted signal components are labelled in the figure. The run uses
...
\(\Delta_{\mathrm{inh}}=0\) and \(N_{\mathrm{inhom}}=1\).
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \safeplaceholdergraphic[1.22\linewidth]{\dimerFigFourWaitZeroPaperTimePath}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \safeplaceholdergraphic[1.22\linewidth]{\dimerFigFourWaitSixteenPaperTimePath}
    \end{minipage}
    \caption{Dimer time-domain waiting-time panels for
    \(t_{\mathrm{wait}}=\SI{0}{\femto\second}\) (left) and
    \(t_{\mathrm{wait}}=\SI{16}{\femto\second}\) (right). Shared dimer settings
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \safeplaceholdergraphic[1.22\linewidth]{\dimerFigFourWaitThirtyPaperTimePath}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \safeplaceholdergraphic[1.22\linewidth]{\dimerFigFourWaitFortySixPaperTimePath}
    \end{minipage}
    \caption{Dimer time-domain waiting-time panels for
    \(t_{\mathrm{wait}}=\SI{30}{\femto\second}\) (left) and
    \(t_{\mathrm{wait}}=\SI{46}{\femto\second}\) (right). Shared dimer settings
    are listed in~\autoref{subsec:results_dimer_model}.}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \safeplaceholdergraphic[1.22\linewidth]{\dimerFigFourWaitSixtyTwoPaperTimePath}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \safeplaceholdergraphic[1.22\linewidth]{\dimerFigFourWaitOneOhEightPaperTimePath}
    \end{minipage}
    \caption{Dimer time-domain waiting-time panels for
    \(t_{\mathrm{wait}}=\SI{62}{\femto\second}\) (left) and
    \(t_{\mathrm{wait}}=\SI{108}{\femto\second}\) (right). Shared dimer settings
    are listed in~\autoref{subsec:results_dimer_model}.}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \safeplaceholdergraphic[1.22\linewidth]{\dimerFigFourWaitOneFortyPaperTimePath}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \safeplaceholdergraphic[1.22\linewidth]{\dimerFigFourWaitThreeTenPaperTimePath}
    \end{minipage}
    \caption{Dimer time-domain waiting-time panels for
    \(t_{\mathrm{wait}}=\SI{140}{\femto\second}\) (left) and
    \(t_{\mathrm{wait}}=\SI{310}{\femto\second}\) (right). Shared dimer settings
    are listed in~\autoref{subsec:results_dimer_model}.}
...
\begin{figure}[htbp]
    ...
    for the same runs as in~\autoref{fig:app_dimer_fig6_time}. Shared dimer
