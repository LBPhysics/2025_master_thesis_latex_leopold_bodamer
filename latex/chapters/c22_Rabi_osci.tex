...
\end{equation}
The time evolution of the system is governed by the time-dependent Schrödinger equation \autoref{eq:SchrödingerEquation}
...
\begin{itemize}
	\item \textbf{Free Hamiltonian:}
	      \begin{equation}
		      \tilde{H}_0 = \frac{(\omega_0 - \omega_L)}{2} \sigma_z = \frac{\Delta}{2} \sigma_z
...
\begin{equation}
	\\frac{d}{dt}\\rho = -i[\tilde{H}, \rho] + \mathcal{D}(\rho)
...
\begin{equation}
	\boxed{
		\begin{aligned}
			\\frac{d}{dt}\\rho_{ee} & = i \Omega_c \rho_{ge} - i \Omega_c^* \rho_{eg} - \gamma_0 \rho_{ee}            \\[6pt]
			\\frac{d}{dt}\\rho_{gg} & = -i \Omega_c \rho_{ge} + i \Omega_c^* \rho_{eg} + \gamma_0 \rho_{ee}           \\[6pt]
			\\frac{d}{dt}\\rho_{eg} & = i \Delta \rho_{eg} + i \Omega_c (\rho_{gg} - \rho_{ee}) - \Gamma \rho_{eg}    \\[6pt]
			\\frac{d}{dt}\\rho_{ge} & = -i \Delta \rho_{ge} - i \Omega_c^* (\rho_{gg} - \rho_{ee}) - \Gamma \rho_{ge}
		\end{aligned}
	}
