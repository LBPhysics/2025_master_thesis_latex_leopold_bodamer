...
\begin{equation}
	...
	\end{pmatrix}.
\end{equation}
This can be found in the analytical implementation of paper I (see~\autoref{app:sec:paper_eqs_explicit_eoms}) \cite{mancaletal2006twodimensionalopticalthreepulse}.
