...
\noindent The following paragraph illustrates the use of todo notes. The Fourier transform is a mathematical transform that decomposes a function into its constituent frequencies. \todoimp{Complete this explanation with the formal definition!}

\noindent When discussing the Hamiltonian of a quantum system, it is typically written as:
\begin{equation}
	H = H_0 + H_{\mathrm{int}}
\end{equation}
...
\noindent In the phase-matching conditions section \todoidea{Add a diagram illustrating the k-vector directions in FWM experiments}
