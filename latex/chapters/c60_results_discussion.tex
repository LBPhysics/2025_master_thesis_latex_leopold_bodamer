...
In this section, we present the key results from our 2D spectroscopy simulations for the monomer system.
...
Homogeneous broadening means every molecule behaves the same. All peaks are round and symmetric because only lifetime and dephasing limit the linewidth.

Inhomogeneous broadening occurs when each molecule has a slightly different transition frequency due to disorder. When averaged, the peaks stretch along the diagonal of the 2D plot (excitation $\approx$ emission). This diagonal elongation serves as the "fingerprint" of static disorder.
