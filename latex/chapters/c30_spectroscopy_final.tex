...
\label{sec:concept_light_matter}
\noindent
...
e^{+i\omega_{\mathrm{coh}} t_{\mathrm{coh}}}\,e^{-i\omega_{\mathrm{det}} t_{\mathrm{det}}}\;\varepsilon_{R}(t_{\mathrm{coh}},T,t_{\mathrm{det}}), \label{eq:SR}\\
S_{NR}(\omega_{\mathrm{coh}},T,\omega_{\mathrm{det}})
&=\int \mathrm{d}t_{\mathrm{coh}}\,\mathrm{d}t_{\mathrm{det}}\;
e^{-i\omega_{\mathrm{coh}} t_{\mathrm{coh}}}\,e^{-i\omega_{\mathrm{det}} t_{\mathrm{det}}}\;\varepsilon_{NR}(t_{\mathrm{coh}},T,t_{\mathrm{det}}), \label{eq:SNR}
\end{align}
